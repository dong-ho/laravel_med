...
{
    protected $baseRouteName = 'admin.manager';

    /**
     * name      : List
     * author    : HDH
     * date      : 2025/03/05  3:05 PM
     * description : 관리자 리스트 뷰
     * --------------------------------------------------------
     * @return View
     * --------------------------------------------------------
     */
