...
{
    protected $baseRouteName = 'admin.usermenu';

    /**
     * name      : List
     * author    : HDH
     * date      : 2025/03/10  6:19 PM
     * description : 사용자 메뉴 리스트 뷰
     * --------------------------------------------------------
     * @return View
     * --------------------------------------------------------
     */
    ...
    {
        $lists = UserMenus::whereNull('parent_id')
    ...
    {
        $parentLists = UserMenus::parentLists();
