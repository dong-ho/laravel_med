...
@section('contents')
    <div class="col-xl-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="formMenu" method="POST" action="{{ route('admin.user.edit',['id' => $list->id] + request()->query()) }}" enctype="multipart/form-data">
                    @csrf
                    <dif class="row">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('admin.user', request()->query()) }}"  class="btn btn-outline-secondary">
            ...
            if (deleteBtn) {
                deleteBtn.onclick = function () {
                    if (confirm('이미지를 삭제 하시겠습니까?')) {
                        ...
                        xhr.open('POST', '{{ route('admin.user.photo.delete') }}', true);
