    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="col-end-auto">
                <h5 class="mb-0"></h5>
                <a href="{{ route('admin.manager.add', request()->query()) }}">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('admin.manager.edit',['id'=>$list->id] + request()->query()) }}"><i class="bx bx-edit-alt me-1"></i> 수정</a>
                                <a class="dropdown-item" href="{{ route('admin.manager.delete',['id'=>$list->id] + request()->query()) }}" onclick="return confirm('삭제 하시겠습니까?')"><i class="bx bx-trash me-1"></i> 삭제</a>
                            </div>
                        </div>
                    </td>
                </tr>
